...
highlight Conditional gui=None   guifg=#f80 guibg=bg
highlight Repeat      gui=None   guifg=#f80 guibg=bg
"highlight Label gui=None guifg=LightGreen guibg=bg
highlight Operator    gui=bold   guifg=#f80 guibg=bg
highlight Keyword     gui=bold   guifg=#ff0 guibg=bg
